...
Frontend tries to login at: https://nyc-apt-finder.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://nyc-apt-finder.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://nyc-apt-finder.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://nyc-apt-finder.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://nyc-apt-finder.preview.emergentagent.com",
"logo": "https://nyc-apt-finder.preview.emergentagent.com/logo.png",
```
