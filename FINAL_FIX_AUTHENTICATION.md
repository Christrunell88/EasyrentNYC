...
Frontend tries to login at: https://nofee-finder-1.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://nofee-finder-1.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://nofee-finder-1.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://nofee-finder-1.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://nofee-finder-1.preview.emergentagent.com",
"logo": "https://nofee-finder-1.preview.emergentagent.com/logo.png",
```
