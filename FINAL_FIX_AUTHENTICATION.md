...
Frontend tries to login at: https://nofee-apt-search.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://nofee-apt-search.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://nofee-apt-search.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://nofee-apt-search.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://nofee-apt-search.preview.emergentagent.com",
"logo": "https://nofee-apt-search.preview.emergentagent.com/logo.png",
```
