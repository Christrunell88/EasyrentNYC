...
Frontend tries to login at: https://fee-free-rentals.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://fee-free-rentals.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://fee-free-rentals.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://fee-free-rentals.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://fee-free-rentals.preview.emergentagent.com",
"logo": "https://fee-free-rentals.preview.emergentagent.com/logo.png",
```
