...
Frontend tries to login at: https://feefreeapts-1.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://feefreeapts-1.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://feefreeapts-1.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://feefreeapts-1.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://feefreeapts-1.preview.emergentagent.com",
"logo": "https://feefreeapts-1.preview.emergentagent.com/logo.png",
```
