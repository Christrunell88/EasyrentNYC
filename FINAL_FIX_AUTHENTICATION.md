...
Frontend tries to login at: https://no-fee-listings-dev.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://no-fee-listings-dev.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://no-fee-listings-dev.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://no-fee-listings-dev.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://no-fee-listings-dev.preview.emergentagent.com",
"logo": "https://no-fee-listings-dev.preview.emergentagent.com/logo.png",
```
