...
Frontend tries to login at: https://rentdirect-6.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://rentdirect-6.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://rentdirect-6.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://rentdirect-6.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://rentdirect-6.preview.emergentagent.com",
"logo": "https://rentdirect-6.preview.emergentagent.com/logo.png",
```
