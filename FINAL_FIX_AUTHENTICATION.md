...
Frontend tries to login at: https://feefreeapts.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://feefreeapts.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://feefreeapts.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://feefreeapts.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://feefreeapts.preview.emergentagent.com",
"logo": "https://feefreeapts.preview.emergentagent.com/logo.png",
```
