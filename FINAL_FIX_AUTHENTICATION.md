...
Frontend tries to login at: https://nofeesapts-preview.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://nofeesapts-preview.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://nofeesapts-preview.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://nofeesapts-preview.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://nofeesapts-preview.preview.emergentagent.com",
"logo": "https://nofeesapts-preview.preview.emergentagent.com/logo.png",
```
