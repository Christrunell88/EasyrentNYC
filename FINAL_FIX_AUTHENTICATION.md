...
Frontend tries to login at: https://apartmentfinder-1.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://apartmentfinder-1.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://apartmentfinder-1.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://apartmentfinder-1.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://apartmentfinder-1.preview.emergentagent.com",
"logo": "https://apartmentfinder-1.preview.emergentagent.com/logo.png",
```
