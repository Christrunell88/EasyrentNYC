...
Frontend tries to login at: https://nofeesapts-1.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://nofeesapts-1.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://nofeesapts-1.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://nofeesapts-1.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://nofeesapts-1.preview.emergentagent.com",
"logo": "https://nofeesapts-1.preview.emergentagent.com/logo.png",
```
