...
Frontend tries to login at: https://freefeeapts.preview.emergentagent.com/api/auth/login
...
**Before:**
```javascript
const defaultImage = 'https://freefeeapts.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://freefeeapts.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://freefeeapts.preview.emergentagent.com",
"logo": "https://freefeeapts.preview.emergentagent.com/logo.png",
```
