...
Frontend tries to login at: https://zerofeerentals.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://zerofeerentals.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://zerofeerentals.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://zerofeerentals.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://zerofeerentals.preview.emergentagent.com",
"logo": "https://zerofeerentals.preview.emergentagent.com/logo.png",
```
