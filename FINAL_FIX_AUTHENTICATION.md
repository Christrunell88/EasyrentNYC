...
Frontend tries to login at: https://rentnoagent.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://rentnoagent.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://rentnoagent.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://rentnoagent.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://rentnoagent.preview.emergentagent.com",
"logo": "https://rentnoagent.preview.emergentagent.com/logo.png",
```
