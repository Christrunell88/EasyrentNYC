...
Frontend tries to login at: https://feelessapts.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://feelessapts.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://feelessapts.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://feelessapts.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://feelessapts.preview.emergentagent.com",
"logo": "https://feelessapts.preview.emergentagent.com/logo.png",
```
