...
Frontend tries to login at: https://apartments-qa-env.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://apartments-qa-env.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://apartments-qa-env.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://apartments-qa-env.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://apartments-qa-env.preview.emergentagent.com",
"logo": "https://apartments-qa-env.preview.emergentagent.com/logo.png",
```
