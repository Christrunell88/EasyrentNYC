...
Frontend tries to login at: https://apt-crawler-staging.preview.emergentagent.com/api/auth/login
...
**Before:**
```
REACT_APP_BACKEND_URL=https://apt-crawler-staging.preview.emergentagent.com
```
...
**Before:**
```javascript
const defaultImage = 'https://apt-crawler-staging.preview.emergentagent.com/og-image.jpg';
const baseUrl = 'https://apt-crawler-staging.preview.emergentagent.com';
```
...
**Before:**
```javascript
"url": "https://apt-crawler-staging.preview.emergentagent.com",
"logo": "https://apt-crawler-staging.preview.emergentagent.com/logo.png",
```
