...
- **API URL**: https://apartment-hub-dev-1.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://apartment-hub-dev-1.preview.emergentagent.com/api
...
# Test API
curl https://apartment-hub-dev-1.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://apartment-hub-dev-1.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
