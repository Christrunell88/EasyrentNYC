...
- **API URL**: https://nofeesapts.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://nofeesapts.preview.emergentagent.com/api
...
# Test API
curl https://nofeesapts.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://nofeesapts.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
