...
- **API URL**: https://nofee-finder-1.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://nofee-finder-1.preview.emergentagent.com/api
...
# Test API
curl https://nofee-finder-1.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://nofee-finder-1.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
