...
- **API URL**: https://direct-rent-nyc.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://direct-rent-nyc.preview.emergentagent.com/api
...
# Test API
curl https://direct-rent-nyc.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://direct-rent-nyc.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
