...
- **API URL**: https://nyc-nofee.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://nyc-nofee.preview.emergentagent.com/api
...
# Test API
curl https://nyc-nofee.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://nyc-nofee.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
