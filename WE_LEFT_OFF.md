...
- **API URL**: https://feefreeapts.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://feefreeapts.preview.emergentagent.com/api
...
# Test API
curl https://feefreeapts.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://feefreeapts.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
