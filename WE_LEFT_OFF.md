...
- **API URL**: https://feefree-flats.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://feefree-flats.preview.emergentagent.com/api
...
# Test API
curl https://feefree-flats.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://feefree-flats.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
