...
- **API URL**: https://nyc-apt-finder.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://nyc-apt-finder.preview.emergentagent.com/api
...
# Test API
curl https://nyc-apt-finder.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://nyc-apt-finder.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
