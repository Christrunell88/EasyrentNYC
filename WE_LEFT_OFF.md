...
- **API URL**: https://nofeeapts-1.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://nofeeapts-1.preview.emergentagent.com/api
...
# Test API
curl https://nofeeapts-1.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://nofeeapts-1.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
