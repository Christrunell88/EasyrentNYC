...
- **API URL**: https://feefree-rentals.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://feefree-rentals.preview.emergentagent.com/api
...
# Test API
curl https://feefree-rentals.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://feefree-rentals.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
