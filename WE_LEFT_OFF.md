...
- **API URL**: https://apt-crawler-staging.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://apt-crawler-staging.preview.emergentagent.com/api
...
# Test API
curl https://apt-crawler-staging.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://apt-crawler-staging.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
