...
- **API URL**: https://zerofeerentals.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://zerofeerentals.preview.emergentagent.com/api
...
# Test API
curl https://zerofeerentals.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://zerofeerentals.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
