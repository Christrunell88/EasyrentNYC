...
- **API URL**: https://malt-drive-images.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://malt-drive-images.preview.emergentagent.com/api
...
# Test API
curl https://malt-drive-images.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://malt-drive-images.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
