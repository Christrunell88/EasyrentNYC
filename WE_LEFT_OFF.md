...
- **API URL**: https://zerofeeliving.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://zerofeeliving.preview.emergentagent.com/api
...
# Test API
curl https://zerofeeliving.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://zerofeeliving.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
