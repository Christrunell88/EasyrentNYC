...
- **API URL**: https://fee-free-rentals.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://fee-free-rentals.preview.emergentagent.com/api
...
# Test API
curl https://fee-free-rentals.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://fee-free-rentals.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
