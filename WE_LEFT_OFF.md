...
- **API URL**: https://freefeeapts.preview.emergentagent.com/api
...
### API Endpoints
- **Base URL**: https://freefeeapts.preview.emergentagent.com/api
...
# Test API
curl https://freefeeapts.preview.emergentagent.com/api/units?limit=5
```
...
curl -X POST https://freefeeapts.preview.emergentagent.com/api/admin/crawl/BUILDING_ID \
