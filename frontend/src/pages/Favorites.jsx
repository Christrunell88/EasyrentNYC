          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" data-testid="favorites-grid">
            {favorites.map((favorite) => {
              ...
              return (
                <Card
                  key={unit.id}
                  className="overflow-hidden hover:shadow-2xl hover:shadow-amber-500/20 transition-all cursor-pointer border border-amber-500/20 shadow-xl bg-slate-800/90 backdrop-blur-sm"
                ...
                >
                  <div className="relative h-48 bg-slate-700">
                    ...
                    <button
                      ...
                      className="absolute top-3 right-3 w-10 h-10 bg-slate-800/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform border border-amber-500/30"
